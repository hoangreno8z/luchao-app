...
`;
    ...
    const staticFiles = ['index.html', 'app.js', 'style.css', 'iching_core.js', 'calendar.js', 'seal_stamp.jpg', 'og_cover.jpg', 'og_share_v2.png', 'lightning_bg.jpg', 'hoang_intro_card.png', 'robots.txt', 'sitemap.xml'];
