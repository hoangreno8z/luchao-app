...
export function runTests() {
    ...
    const dev = ngoKiem.deviationDeg !== undefined ? ngoKiem.deviationDeg : ngoKiem.deviation;
    assert(ngoKiem.mountain.name === 'Ngọ' && ngoKiem.isKiemHuong && dev === 3.5, `183.5° = Kiêm Hướng Ngọ lệch 3.5° (Thế Quái)`);
    ...
    assert(archSvg.includes('stroke-width="45"') || archSvg.includes('stroke-width="35"'), 'Nét tường bao ngoài chuẩn CAD nét đậm');
